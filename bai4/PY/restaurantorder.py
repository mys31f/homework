...
class English:
    ...
    with open('english.json') as english_file:
    ...
    def maindishes(self):
        ...
        for i in self.english_data['maindishes']:
            print(i)
        maindish = input(print("Your selection: ")) # chooses maindish and make it accessible to all instances of this class
    ...
    def drinks(self):
        ...
        for i in self.english_data['drinks']:
            print(i)
        drinks = input(print("Your selection: ")) # chooses drinks and make it accessible to all instances of this class
    ...
    def desserts(self):
        ...
        for i in self.english_data['desserts']:
            print(i)
        desserts = input(print("Your selection: ")) # chooses desserts and make it accessible to all instances of this class

    # repeats the order to user and ask if they want to reorder
    def repeat(self):
        print("Your order is:")
        print("Main dish: " + maindish)
        print("Drinks: " + drinks)
        print("Desserts: " + desserts)
        repeat = input(print("Would you like to reorder? (y/n): "))
        if repeat == "y":
            maindish()
            drinks()
            desserts()
...
class Vietnamese: # replicating english class but in vietnamese
    ...
    with open('vietnamese.json') as vietnamese_file:
    ...
    def maindishes(self):
        ...
        for i in self.vietnamese_data['maindishes']:
            print(i)
        maindish = input(print("Your selection: "))
    ...
    def drinks(self):
        ...
        for i in self.vietnamese_data['drinks']:
            print(i)
        drinks = input(print("Your selection: "))
    ...
    def desserts(self):
        ...
        for i in self.vietnamese_data['desserts']:
            print(i)
        desserts = input(print("Your selection: "))
    ...
    def repeat(self):
        ...
        print("Drinks: " + drinks)
        print("Desserts: " + desserts)
        repeat = input(print("Bạn có muốn đặt lại không? (y/n): "))
        if repeat == "y":
            maindish()
            drinks()
            desserts()
